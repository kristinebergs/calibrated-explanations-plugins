...
# Ce Release Task — Core Instructions
...
- Follow CE-first coding rules: use `WrapCalibratedExplainer` through the public API directly; do not use ad-hoc wrappers or `ce_agent_utils` helper shortcuts in new agent-facing examples.
...
description: >
  Author or revise CE capability claim files (CE-CAP-AREA-NNN.yaml) in development/capabilities/claims/; use when adding a new capability claim, updating claim status, or linking a claim to new requirements.
---
...
# Ce Claim Author — Core Instructions
